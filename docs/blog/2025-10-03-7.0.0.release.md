...
title: Release 7.0.0-rc.1 - OpenIAP GQL 1.0.10 & Type Safety
authors: [hyochan]
tags: [release, openiap, flutter, in-app-purchase, breaking-change]
date: 2025-10-21
---

Release 7.0.0-rc.1 migrates to OpenIAP GQL 1.0.10, introducing union types, platform-specific classes, and enhanced type safety. This release focuses on OpenIAP specification compliance while maintaining backward compatibility where possible.
