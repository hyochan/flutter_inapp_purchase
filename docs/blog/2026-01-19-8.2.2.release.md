---
slug: 8.2.2-release
title: "8.2.2 - Win-Back Offers, Product Status, and Suspended Subscriptions"
authors: [hyochan]
tags: [release, ios, android, storekit, billing]
---

v8.2.2 syncs with [OpenIAP v1.3.14](https://www.openiap.dev/docs/updates/notes#gql-1-3-14-google-1-3-25-apple-1-3-12) bringing Win-Back offers for iOS 18+, product-level status codes for Android 8.0+, and suspended subscription support.
